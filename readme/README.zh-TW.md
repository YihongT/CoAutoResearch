...
<p align="center">提出問題，執行實驗，討論發現，改進下一步。<br>從可追溯的證據累積研究稿與論文草稿。</p>
...
- **2026-06-23** — [CoAutoResearch v0.1.1](https://github.com/YihongT/CoAutoResearch/releases/tag/v0.1.1) 發布.
...
**遞迴自我改進。** 將已記錄的結果、審查回饋與可重用經驗帶入下一輪，在研究要求和預算內持續修訂假設、方法與研究決策；保留負面發現，並在證據顯示應當停止時收尾。
...
**支援的 coding agent:** ✓ Codex CLI · ✓ Claude Code
