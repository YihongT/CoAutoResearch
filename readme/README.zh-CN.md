...
<p align="center">提出问题，运行实验，讨论发现，改进下一步。<br>从可追溯的证据积累研究稿与论文草稿。</p>
...
- **2026-09-11** — [CoAutoResearch v2.0.0](https://github.com/YihongT/CoAutoResearch/releases/tag/v2.0.0) 发布.
...
浏览已完成的 Digits 项目：研究记录、研究稿与 PDF。这段经剪辑、裁切的网页导览展示已有历史，不是新一轮运行，也不代表实际研究速度。
