...
**Исследуйте вопрос за несколько итераций.** Агент планирует, выполняет, интерпретирует и проверяет работу в пределах задания и бюджета. Приостановите работу для обдумывания и продолжите, когда будете готовы.
