...
Um ambiente de pesquisa de código aberto baseado em Codex ou Claude Code. Comece com uma pergunta, deixe o agente investigar e executar experimentos, discuta os resultados durante o trabalho e transforme as evidências registradas em um rascunho de artigo.

A pesquisa avança de forma autônoma, e você participa quando seu julgamento é necessário.
...
<small>Estas são traduções do README. A interface e a documentação completa estão em inglês; o agente responde no seu idioma.</small>

<p align="center"><a href="#quick-start">Início rápido</a> · <a href="#features">Recursos</a> · <a href="#example-papers">Artigos de exemplo</a> · <a href="https://yihongt.github.io/CoAutoResearch/">Documentação</a></p>
...
![Comece com uma pergunta, uma proposta ou um trabalho em andamento.](../assets/homepage.png)

*Comece com uma pergunta, uma proposta ou um trabalho em andamento.*
