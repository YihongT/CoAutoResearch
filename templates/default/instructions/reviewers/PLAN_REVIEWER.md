...
- Write `reviews/PLAN_REVIEW.json` under the current trial. The service derives
  its paired `PLAN_REVIEW.md` from validated JSON before approval. The service archives a prior
...
- current `PLAN.json` and `EXPERT_ROUTE.json` (Markdown views may be generated by the service after this review);
